        ...
        if inputs_embeds is None:
            ...
            if has_images_global:
                if pixel_values is not None:   
                    ...
                    #     tokens_batch_decode = self.tokenizer.batch_decode(input_ids)
                    #     for token_i, token_batch_decode in enumerate(tokens_batch_decode):
                    #         print(f"self.tokenizer.batch_decode(input_ids)[{token_i}]: ", token_batch_decode)
